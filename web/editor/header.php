...
<div id="header">    
    ...
    <div id="dropdown">
        ...
        <!--File menu-->
        <div class="dropdown_menu"><a href="#" onmouseover="dropdownSpace.menuOpen('file')" onmouseout="dropdownSpace.menuCloseTime()">Datei</a>
            <div class="dropdown_menu_panel" id="file" onmouseover="dropdownSpace.menuCancelCloseTime()" onmouseout="dropdownSpace.menuCloseTime()">
                ...
                <?if($page=='editor'){?>
                    ...
                    <?if(isset($_REQUEST['diagramId']) &&  is_numeric($_REQUEST['diagramId']) ){//option available ony when the diagram was saved?>
                        <a style="text-decoration: none; border-bottom: 1px solid #666;" href="./exportDiagram.php?diagramId=<?=$_REQUEST['diagramId']?>"  title="Export diagram"><img style="vertical-align:middle; margin-right: 3px;" src="assets/images/icon_export.jpg" border="0" width="22" height="22"/><span class="menuText">Exportieren</span></a>
                        <a style="text-decoration: none; border-bottom: 1px solid #666;" href="javascript:print_diagram();" title="Print diagram"><img style="vertical-align:middle; margin-right: 3px;" src="assets/images/icon_print.png" border="0" width="20" height="21"/><span class="menuText">Drucken</span></a>
                    <?}?>
                <?}?>
                <?if (is_object($loggedUser)) { ?>    
                <a style="text-decoration: none;" href="./common/controller.php?action=logoutExe"><img style="vertical-align:middle;" src="<?=$WEBADDRESS?>/editor/assets/images/icon_logout.gif" border="0" width="16" height="16"/><span class="menuText">Abmelden (<?= $loggedUser->email ?>)</span></a>
                <?}?>
            </div>
        </div>
        <!-- /File menu-->
        ...
        <!--Settings menu-->
        <div class="dropdown_menu"><a href="#" onmouseover="dropdownSpace.menuOpen('settings')" onmouseout="dropdownSpace.menuCloseTime()">Einstellungen</a>
            <div class="dropdown_menu_panel"  id="settings" onmouseover="dropdownSpace.menuCancelCloseTime()" onmouseout="dropdownSpace.menuCloseTime()">
                <a href="./settings.php">Meine Einstellungen</a>
            </div>
        </div>
        <!--Settings menu-->
        
        <!--Users menu-->
        <div class="dropdown_menu"><a href="#" onmouseover="dropdownSpace.menuOpen('users')" onmouseout="dropdownSpace.menuCloseTime()">Benutzer</a>
            <div class="dropdown_menu_panel"  id="users" onmouseover="dropdownSpace.menuCancelCloseTime()" onmouseout="dropdownSpace.menuCloseTime()">
                <a style="text-decoration: none;" href="./users.php"  title="Invite/Manage collaborators"><img style="vertical-align:middle; margin-right: 3px;" src="assets/images/collaborators.gif" border="0" width="22" height="22"/><span class="menuText">Benutzer</span></a>
            </div>
        </div>
        <!--Help menu-->
        
        <!--Help menu-->
        <div class="dropdown_menu"><a href="#" onmouseover="dropdownSpace.menuOpen('help')" onmouseout="dropdownSpace.menuCloseTime()">Hilfe</a>            
            <div class="dropdown_menu_panel" id="help"    onmouseover="dropdownSpace.menuCancelCloseTime()" onmouseout="dropdownSpace.menuCloseTime()" >
                <a href="https://bitbucket.org/scriptoid/diagramo/issues/new" target="new">Melde einen Fehler (EN)</a>
                ...
                <a href="javascript:void(0);" onclick="buildNo()">Über</a>
        ...
        <?if($page=='editor'){?>
            ...
            <div style="padding-top: 6px;">
                ...
                <span class="menuText" title="Use this URL to share diagram to others">Direct link : </span> <input style="font-size: 10px;" title="Externe Adresse für das Diagram:" type="text" class="text" size="100" value="<?=$url?>"/>
                <input type="button" style="" value="Gucken" onclick="window.open('<?=$url?>')"/>
            </div>
            <?}?>
        <?}?>
        <!-- //Direct link-->
        ...
        <script type="text/javascript">
            ...
            if(!isBrowserReady()){                
                ...
                document.write("Kein support für HTML5. Mehr darüber finden Sie <a href=\"http://<?=$WEBADDRESS?>/htm5-support.php\">hier</a></a>");
                document.write("</span>");                
            }
        </script>   
