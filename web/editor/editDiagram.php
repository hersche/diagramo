...
<html>
    <head>
        <title>Diagramo - Diagram bearbeiten</title>
        ...
        <div id="page">
            ...
            <div id="content">
                ...
                <div class="form" style="width: 400px;">
                    <div class="formTitle" >
                        <span class="menuText" style="font-size: 14px; font-family: Arial; color: #6E6E6E;">Bearbeiten</span>
                    </div>
                    ...
                    <form  style="position: relative; height: 270px;" action="./common/controller.php" method="post">
                        ...
                        <div style="position: absolute; top: 160px; left: 20px;">
                            <input type="checkbox" name="public" value="true" <?=$diagram->public ? 'checked' : '' ?>/><span class="formLabel">Öffentlich</span>
                        </div>
