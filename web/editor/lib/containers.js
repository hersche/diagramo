...
function Container(id, topLeft, bottomRight) {
    ...
    this.properties.push(new BuilderProperty('Rahmenfarbe', 'style.strokeStyle', BuilderProperty.TYPE_COLOR));
    this.properties.push(new BuilderProperty('Hintergrundfarbe', 'style.fillStyle', BuilderProperty.TYPE_COLOR));
    this.properties.push(new BuilderProperty('Ra-Breite', 'style.lineWidth',BuilderProperty.TYPE_LINE_WIDTH));
    this.properties.push(new BuilderProperty('Rahmenstil', 'style.lineStyle',BuilderProperty.TYPE_LINE_STYLE));
